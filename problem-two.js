...
// Luckily for you, the writer of these JavaScript problems doesn't want you to die, 
// so you also miraculously have a fleet of robot turrets at your command to help repel the attack.
// Write a function called directTurretDefenceCommand that takes in 2 parameters: 
// The first should be called numOfTurrets 
//(which will always be given a positive integer argument value),
// and the second should be called numOfDetectedZombies 
// (which will always be given a positive integer argument value).
